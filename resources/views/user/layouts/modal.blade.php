                    ...
                    <div class="tf-col-content">
                        ...
                        <div class="tf-search-hidden-inner">
                            <div class="tf-loop-item">
                                ...
                                <div class="content">
                                    <a href="{{route ('products') }}">Cotton jersey top</a>
                            ...
                            <div class="tf-loop-item">
                                ...
                                <div class="content">
                                    <a href="{{route ('products') }}">Mini crossbody bag</a>
                                    <div class="tf-product-info-price">
                            ...
                            <div class="tf-loop-item">
                                ...
                                <div class="content">
                                    <a href="{{route ('products') }}">Oversized Printed T-shirt</a>
                                    <div class="tf-product-info-price">
                                        <div class="price fw-6">$18.00</div>
                                    </div>
                                </div>
...
<div class="offcanvas offcanvas-start canvas-mb toolbar-shop-mobile" id="toolbarShopmb">
    ...
    <div class="mb-canvas-content">
                            ...
                            <li>
                                ...
                                <div id="cate-shop-one" class="collapse">
                                    <ul class="sub-nav-menu sub-menu-level-2">
                                        <li>
                                            <a href="{{route ('shop') }}" class="tf-category-link sub-nav-link">
                                                <div class="image">
        ...
        <div class="mb-bottom">
            <a href="{{route ('shop') }}" class="tf-btn fw-5 btn-line">View all collection<i class="icon icon-arrow1-top-left"></i></a>
        </div>
    </div>
</div>
<!-- /toolbarShopmb -->
            ...
            <div class="tf-login-form">
                <form method="POST" action="" autocomplete="off">
                    ...
                    <div class="tf-field style-1">
                        ...
                        <label class="tf-field-label" for="">Nama</label>
                    </div>
                    <div class="tf-field style-1">
                        <input class="tf-field-input tf-input" placeholder="Masukkan Email Anda" type="email" name="">
                        <label class="tf-field-label" for="">Email</label>
                    </div>
                    <div class="tf-field style-1">
                        <input class="tf-field-input tf-input" placeholder=" " type="text" name="">
                        <label class="tf-field-label" for="">Nomer Handphone</label>
                    </div>
                    <div class="tf-field style-1">
                        <input class="tf-field-input tf-input" placeholder="Masukkan Kata Sandi Anda" type="password" name="password">
...
<div class="modal modalCentered fade form-sign-in modal-part-content" id="login">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="tf-login-form">
                <form class="" action="POST" accept-charset="utf-8">
                    @csrf
                    <div class="tf-field style-1">
                        <input class="tf-field-input tf-input" placeholder="Masukkan Email Anda" type="email" name="email">
                        <label class="tf-field-label" for="">Email</label>
                    </div>
                    <div class="tf-field style-1">
                        <input class="tf-field-input tf-input" placeholder="Masukkan Kata Sandi Anda" type="password" name="password">
                    ...
                    <div class="bottom">
                        <div class="w-100">
                            <button type="submit" class="tf-btn btn-fill animate-hover-btn radius-3 w-100 justify-content-center"><span>Masuk</span></button>
                        </div>
                        <div class="w-100">
        ...
        <div class="modal-content">
            ...
            <div class="tf-login-form">
                <form class="">
                    ...
                    <div class="bottom">
                        <div class="w-100">
                            <button type="submit" class="tf-btn btn-fill animate-hover-btn radius-3 w-100 justify-content-center"><span>Setel ulang kata sandi</span></button>
                        </div>
                    </div>
                </form>
            </div>
                            ...
                            <div class="tf-mini-cart-items">
                                <div class="tf-mini-cart-item">
                                    ...
                                    <div class="tf-mini-cart-info">
                                        <a class="title link" href="{{route ('products') }}">T-shirt</a>
                                ...
                                <div class="tf-mini-cart-item">
                                    ...
                                    <div class="tf-mini-cart-info">
                                        <a class="title link" href="{{route ('products') }}">Oversized Motif T-shirt</a>
                                        <div class="price fw-6">$25.00</div>
                                        <div class="tf-mini-cart-btns">
                                            <div class="wg-quantity small">
                                                <span class="btn-quantity minus-btn">-</span>
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="tf-minicart-recommendations-item">
                                                ...
                                                <div class="tf-minicart-recommendations-item-infos flex-grow-1">
                                                    <a class="title" href="{{route ('products') }}">Loose Fit Sweatshirt</a>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-minicart-recommendations-item">
                                                ...
                                                <div class="tf-minicart-recommendations-item-infos flex-grow-1">
                                                    <a class="title" href="{{route ('products') }}">Loose Fit Hoodie</a>
                                                    <div class="price">$25.00</div>
                                                </div>
                                                <div class="tf-minicart-recommendations-item-quickview">
                                                    <div class="btn-show-quickview quickview hover-tooltip">
                            ...
                            <div class="tf-compare-offcanvas">
                                <div class="tf-compare-item">
                                    <div class="position-relative">
                                        ...
                                        <a href="{{route ('products') }}">
                                            <img class="radius-3" src="{{asset('assets/user/images/products/orange-1.jpg') }}" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="tf-compare-item">
        ...
        <div class="modal-content">
            ...
            <div class="wrap">
                <div class="tf-product-info-item">
                    <div class="image">
                        <img src="{{asset('assets/user/images/products/orange-1.jpg') }}" alt="">
                    </div>
                    <div class="content">
                        <a href="{{route ('products') }}">Ribbed Tank Top</a>
                        <div class="tf-product-info-price">
                ...
                <div class="tf-product-info-wrap position-relative">
                    <div class="tf-product-info-list">
                        <div class="tf-product-info-title">
                            <h5><a class="link" href="{{route ('products') }}">Ribbed Tank Top</a></h5>
                        </div>
                        ...
                        <div>
                            <a href="{{route ('products') }}" class="tf-btn fw-6 btn-line">View full details<i class="icon icon-arrow1-top-left"></i></a>
                        </div>
                    </div>
                </div>
            </div>
