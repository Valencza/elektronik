                        ...
                        <div dir="ltr" class="swiper tf-sw-top_bar" data-preview="1" data-space="0" data-loop="true" data-speed="1000" data-delay="2000">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <p class="top-bar-text fw-5 text_white">Season Sale: Time to refresh your wardrobe. <a href="{{route ('shop') }}" title="all collection" class="tf-btn btn-line">Shop now<i class="icon icon-arrow1-top-left"></i></a></p>
                                </div>
                                <div class="swiper-slide">
                                    <p class="top-bar-text fw-5 text_white">Discount off 50%. <a href="{{route ('shop') }}" title="all collection" class="tf-btn btn-line">Shop now<i class="icon icon-arrow1-top-left"></i></a></p>
                                </div>
                                <div class="swiper-slide">
                    ...
                    <div class="col-xl-6 tf-md-hidden">
                        <nav class="box-navigation text-center">
                            <ul class="box-nav-ul d-flex align-items-center justify-content-center gap-30">
                                ...
                                <li class="menu-item">
                                    <a href="{{route ('products') }}" class="item-link">Products</i></a>
                                </li>
                                <li class="menu-item">
                                    <a href="{{route ('contacts') }}" class="item-link">Contact Us</i></a>
                                </li>
                            </ul>
                        </nav>
                    </div>
            ...
            <div class="mb-body">
                ...
                <div class="mb-other-content">
                    <div class="d-flex group-icon">
                        <a href="{{route ('wishlists') }}" class="site-nav-icon"><i class="icon icon-heart"></i>Wishlist</a>
