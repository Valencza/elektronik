                    ...
                    <div class="top-bar-language tf-cur justify-content-end">
                        <div class="tf-currencies">
                            <select class="image-select center style-default type-currencies color-white">
                                <option data-thumbnail="{{asset ('assets/user/images/country/fr.svg') }}">EUR <span>€ | France</span></option>
                                <option data-thumbnail="{{asset ('assets/user/images/country/de.svg') }}">EUR <span>€ | Germany</span></option>
                                <option selected data-thumbnail="{{asset ('assets/user/images/country/us.svg') }}">USD <span>$ | United States</span></option>
                                <option data-thumbnail="{{asset ('assets/user/images/country/vn.svg') }}">VND <span>₫ | Vietnam</span></option>
                            </select>
                        </div>
                ...
                <div class="row wrapper-header align-items-center">
                    ...
                    <div class="col-xl-3 col-md-4 col-6">
                        <a href="index.html" class="logo-header">
                            <img src="{{asset ('assets/user/images/logo/logo.svg') }}" alt="logo" class="logo">
                        </a>
                    </div>
                                                    ...
                                                    <div class="collection-item hover-img">
                                                        <div class="collection-inner">
                                                            <a href="shop-men.html" class="collection-image img-style">
                                                                <img class="lazyload" data-src="{{asset ('assets/user/images/collections/collection-1.jpg') }}" src="{{asset ('assets/user/images/collections/collection-1.jpg') }}" alt="collection-demo-1">
                                                            </a>
                                                    ...
                                                    <div class="collection-item hover-img">
                                                        <div class="collection-inner">
                                                            <a href="shop-women.html" class="collection-image img-style">
                                                                <img class="lazyload" data-src="{{asset ('assets/user/images/collections/collection-2.jpg') }}" src="{{asset ('assets/user/images/collections/collection-2.jpg') }}" alt="collection-demo-1">
                                                            </a>
                                                            <div class="collection-content">
                                                            ...
                                                            <div class="swiper-wrapper">
                                                                    ...
                                                                    <div class="card-product">
                                                                        <div class="card-product-wrapper">
                                                                            <a href="#" class="product-img">
                                                                                <img class="lazyload img-product" data-src="{{asset ('assets/user/images/products/orange-1.jpg') }}" src="{{asset ('assets/user/images/products/orange-1.jpg') }}" alt="image-product">
                                                                                <img class="lazyload img-hover" data-src="{{asset ('assets/user/images/products/white-1.jpg') }}" src="{{asset ('assets/user/images/products/white-1.jpg') }}" alt="image-product">
                                                                            </a>
                                                                        ...
                                                                        <div class="card-product-info">
                                                                            ...
                                                                            <ul class="list-color-product">
                                                                                <li class="list-color-item color-swatch active">
                                                                                    ...
                                                                                    <img class="lazyload" data-src="{{asset ('assets/user/images/products/orange-1.jpg') }}" src="{{asset ('assets/user/images/products/orange-1.jpg') }}" alt="image-product">
                                                                                </li>
                                                                                <li class="list-color-item color-swatch">
                                                                                    <span class="tooltip">Black</span>
                                                                                    <span class="swatch-value bg_dark"></span>
                                                                                    <img class="lazyload" data-src="{{asset ('assets/user/images/products/black-1.jpg') }}" src="{{asset ('assets/user/images/products/black-1.jpg') }}" alt="image-product">
                                                                                </li>
                                                                                <li class="list-color-item color-swatch">
                                                                                    <span class="tooltip">White</span>
                                                                                    <span class="swatch-value bg_white"></span>
                                                                                    <img class="lazyload" data-src="{{asset ('assets/user/images/products/white-1.jpg') }}" src="{{asset ('assets/user/images/products/white-1.jpg') }}" alt="image-product">
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="card-product">
                                                                        <div class="card-product-wrapper">
                                                                            <div class="product-img">
                                                                                <img class="lazyload img-product" data-src="{{asset ('assets/user/images/products/white-3.jpg') }}" src="{{asset ('assets/user/images/products/white-3.jpg') }}" alt="image-product">
                                                                                <img class="lazyload img-hover" data-src="{{asset ('assets/user/images/products/white-4.jpg') }}" src="{{asset ('assets/user/images/products/white-4.jpg') }}" alt="image-product">
                                                                            </div>
                                                                            <div class="list-product-btn absolute-2">
                                                                ...
                                                                <div class="swiper-slide" lazy="true">
                                                                    <div class="card-product">
                                                                        <div class="card-product-wrapper">
                                                                            <div class="product-img">
                                                                                <img class="lazyload img-product" data-src="{{asset ('assets/user/images/products/white-2.jpg') }}" src="{{asset ('assets/user/images/products/white-2.jpg') }}" alt="image-product">
                                                                                <img class="lazyload img-hover" data-src="{{asset ('assets/user/images/products/pink-1.jpg') }}" src="{{asset ('assets/user/images/products/pink-1.jpg') }}" alt="image-product">
                                                                            </div>
                                                                        ...
                                                                        <div class="card-product-info">
                                                                            ...
                                                                            <ul class="list-color-product">
                                                                                <li class="list-color-item color-swatch active">
                                                                                    <span class="tooltip">White</span>
                                                                                    <span class="swatch-value bg_white"></span>
                                                                                    <img class="lazyload" data-src="{{asset ('assets/user/images/products/white-2.jpg') }}" src="{{asset ('assets/user/images/products/white-2.jpg') }}" alt="image-product">
                                                                                </li>
                                                                                <li class="list-color-item color-swatch">
                                                                                    <span class="tooltip">Pink</span>
                                                                                    <span class="swatch-value bg_purple"></span>
                                                                                    <img class="lazyload" data-src="{{asset ('assets/user/images/products/pink-1.jpg') }}" src="{{asset ('assets/user/images/products/pink-1.jpg') }}" alt="image-product">
                                                                                </li>
                                                                                <li class="list-color-item color-swatch">
                                                                                    <span class="tooltip">Black</span>
                                                                                    <span class="swatch-value bg_dark"></span>
                                                                                    <img class="lazyload" data-src="{{asset ('assets/user/images/products/black-2.jpg') }}" src="{{asset ('assets/user/images/products/black-2.jpg') }}" alt="image-product">
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="swiper-slide" lazy="true">
                                                                    <div class="card-product">
                                                                        <div class="card-product-wrapper">
                                                                            <div class="product-img">
                                                                                <img class="lazyload img-product" data-src="{{asset ('assets/user/images/products/brown-2.jpg') }}" src="{{asset ('assets/user/images/products/brown-2.jpg') }}" alt="image-product">
                                                                                <img class="lazyload img-hover" data-src="{{asset ('assets/user/images/products/brown-3.jpg') }}" src="{{asset ('assets/user/images/products/brown-3.jpg') }}" alt="image-product">
                                                                            </div>
                                                                            <div class="size-list">
                                                                                <span>S</span>
                                                                                <span>M</span>
                                                                        ...
                                                                        <div class="card-product-info">
                                                                            ...
                                                                            <ul class="list-color-product">
                                                                                <li class="list-color-item color-swatch active">
                                                                                    ...
                                                                                    <img class="lazyload" data-src="{{asset ('assets/user/images/products/brown-2.jpg') }}" src="{{asset ('assets/user/images/products/brown-2.jpg') }}" alt="image-product">
                                                                                </li>
                                                                                <li class="list-color-item color-swatch">
                                                                                    <span class="tooltip">White</span>
                                                                                    <span class="swatch-value bg_white"></span>
                                                                                    <img class="lazyload" data-src="{{asset ('assets/user/images/products/white-5.jpg') }}" src="{{asset ('assets/user/images/products/white-5.jpg') }}" alt="image-product">
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
