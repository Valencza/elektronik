                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6 col-12 footer-col-block">
                                ...
                                <ul class="footer-menu-list tf-collapse-content">
                                    <li>
                                        <a href="about-us.html" class="footer-menu_item">Cerita Kami</a>
                                    </li>
                                    <li> 
                                        <a href="our-store.html" class="footer-menu_item">Kunjungi Toko Kami</a>
                                    </li>
                                    <li> 
                                        <a href="contact-1.html" class="footer-menu_item">Hubungi Kami</a>
                                    </li>
                                    <li> 
                                        <a href="login.html" class="footer-menu_item">Akun</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-xl-3 col-md-6 col-12">
