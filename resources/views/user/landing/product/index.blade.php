                                    ...
                                    <div dir="ltr" class="swiper tf-product-media-main" id="gallery-swiper-started">
                                        <div class="swiper-wrapper" >
                                            <div class="swiper-slide">
                                                <a href="{{asset ('assets/user/images/shop/products/p-d1.png') }}" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="{{asset ('assets/user/images/shop/products/hmgoepprod31.jpg') }}" data-src="{{asset ('assets/user/images/shop/products/hmgoepprod31.jpg') }}" src="{{asset ('assets/user/images/shop/products/hmgoepprod31.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{asset ('assets/user/images/shop/products/hmgoepprod.jpg') }}" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="{{asset ('assets/user/images/shop/products/hmgoepprod.jpg') }}" data-src="{{asset ('assets/user/images/shop/products/hmgoepprod.jpg') }}" src="{{asset ('assets/user/images/shop/products/hmgoepprod.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{asset ('assets/user/images/shop/products/hmgoepprod2.jpg') }}" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="{{asset ('assets/user/images/shop/products/hmgoepprod2.jpg') }}" data-src="{{asset ('assets/user/images/shop/products/hmgoepprod2.jpg') }}" src="{{asset ('assets/user/images/shop/products/hmgoepprod2.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{asset ('assets/user/images/shop/products/hmgoepprod3.jpg') }}" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="{{asset ('assets/user/images/shop/products/hmgoepprod3.jpg') }}" data-src="{{asset ('assets/user/images/shop/products/hmgoepprod3.jpg') }}" src="{{asset ('assets/user/images/shop/products/hmgoepprod3.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{asset ('assets/user/images/shop/products/hmgoepprod4.jpg') }}" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="{{asset ('assets/user/images/shop/products/hmgoepprod4.jpg') }}" data-src="{{asset ('assets/user/images/shop/products/hmgoepprod4.jpg') }}" src="images/shop/products/hmgoepprod4.jpg" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                ...
                                <div class="tf-product-info-list other-image-zoom">
                                    ...
                                    <div class="tf-product-info-buy-button">
                                        <form class="">
                                            ...
                                            <div class="w-100">
                                                <a href="#" class="btns-full">Buy with <img src="{{asset ('assets/user/images/payments/paypal.png') }}" alt=""></a>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product">
                                    ...
                                    <div class="card-product-info">
                                        <a href="{{route ('products') }}" class="title link">Ribbed Tank Top</a>
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product">
                                    ...
                                    <div class="card-product-info">
                                        <a href="{{route ('products') }}" class="title link">Ribbed modal T-shirt</a>
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product">
                                    ...
                                    <div class="card-product-info">
                                        <a href="{{route ('products') }}" class="title link">Oversized Printed T-shirt</a>
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product">
                                    ...
                                    <div class="card-product-info">
                                        <a href="{{route ('products') }}" class="title">Oversized Printed T-shirt</a>
                                        <span class="price">$16.95</span>
                                        <ul class="list-color-product">
                                            <li class="list-color-item color-swatch active">
                                                <span class="tooltip">White</span>
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product">
                                    ...
                                    <div class="card-product-info">
                                        <a href="{{route ('products') }}" class="title link">V-neck linen T-shirt</a>
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product">
                                    ...
                                    <div class="card-product-info">
                                        <a href="{{route ('products') }}" class="title link">Loose Fit Sweatshirt</a>
                                        <span class="price">$10.00</span>
                                        <ul class="list-color-product">
                                            <li class="list-color-item color-swatch active">
                                                <span class="tooltip">Light Green</span>
