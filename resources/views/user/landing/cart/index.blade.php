                                ...
                                <tbody>
                                    <tr class="tf-cart-item file-delete">
                                        <td class="tf-cart-item_product">
                                            <a href="{{route ('products') }}" class="img-box">
                                                <img src="images/products/white-2.jpg" alt="img-product">
                                            </a>
                                            <div class="cart-info">
                                                <a href="{{route ('products') }}" class="cart-title link">Oversized Printed T-shirt</a>
                                    ...
                                    <tr class="tf-cart-item file-delete">
                                        <td class="tf-cart-item_product">
                                            ...
                                            <div class="cart-info">
                                                <a href="{{route ('products') }}" class="cart-title link">Ribbed Tank Top</a>
                                    ...
                                    <tr class="tf-cart-item file-delete">
                                        <td class="tf-cart-item_product">
                                            ...
                                            <div class="cart-info">
                                                <a href="{{route ('products') }}" class="cart-title link">Regular Fit Oxford Shirt</a>
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="content-wrap">
                                            <div class="product-title">
                                                <a href="{{route ('products') }}">Jersey thong body</a>
                                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item style-column">
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="content-wrap">
                                            <div class="product-title">
                                                <a href="{{route ('products') }}">Ribbed modal T-shirt</a>
                                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item style-column">
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="content-wrap">
                                            <div class="product-title">
                                                <a href="{{route ('products') }}">Customer from Japan</a>
                                            </div>
